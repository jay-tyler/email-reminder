...
def main(global_config, **settings):
    ...
    config.add_route('detail_reminder', '/detailreminder/{id}', factory=ReminderFactory, traverse='/{id}')
    config.add_route('create_reminder', '/createreminder')
    config.add_route('edit_reminder', '/editreminder/{id}', factory=ReminderFactory, traverse='/{id}')
